...
各行キー: `TriggerId`, `Name`, `Enabled`, `TargetType`, `TargetId`, `ExecutionMode`, `AutoRunCapability`, `AutoToggle`(ON|OFF|不可), `Priority`, `NextFire`, `LastRunStatus`, `HasError`, `ErrorSummary`（クラウドセーフなメタデータのみ・ルール 90）
