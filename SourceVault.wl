  ...
  Block[{$CharacterEncoding = "UTF-8"},
    Scan[
      ...
      {"SourceVault_core.wl", "SourceVault_simrun.wl",
       ...
       "SourceVault_searchview.wl", "SourceVault_knowledgehome.wl", "SourceVault_cognition.wl", "SourceVault_adjudication.wl", "SourceVault_capbroker.wl", "SourceVault_taint.wl", "SourceVault_anomaly.wl",
